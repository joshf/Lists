...
if (isset($_GET["email"]) && isset($_GET["hash"])) {
    ...
    $subject = "New Lists Password";
	$headers = "MIME-Version: 1.0\r\n";
    $headers .= "From: lists@" . $_SERVER["SERVER_NAME"] . "\r\n";
...
if (isset($_POST["email"])) {
    ...
    $headers .= "From: lists@" . $_SERVER["SERVER_NAME"] . "\r\n";
	$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
    $message = "<html><body><p>Hi " . $userinforesult["user"] . ",</p><p>You have requested to reset your Lists password, to do so click <a href=\"$pathtoscript/reset.php?email=$to&hash=$hash\">here</a> and a new password will be emailed to you.</p><p>If you did not initiate this request, simply ignore this email.</p><p>Your welcome!<br>- The Admin</p></html></body>";
    if (mail($to, $subject, $message, $headers)) {
...
<title>Lists &middot; Reset Password</title>
...
<div class="text-center"><img src="assets/icon.png" width="75" height="75" alt="Lists Logo"></div>
<?php 
