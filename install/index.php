...
<title>Lists &middot; Install</title>
...
if ($step == "0") {    
?>
<p>Welcome to Lists <?php echo $version ?>. Before getting started, we need some information on your database. You will need to know the following items before proceeding.</p>
<ul>
<li>Database name</li>
