...
if ($step == "1") {
    ...
    if ($version == VERSION) {
        die("Information: The latest version of Lists is already installed and an upgrade is not required.");
    }
...
<title>Lists &middot; Upgrade</title>
...
if ($step == "0") {    
?>
<p>Welcome to Lists. You have just downloaded the newest version and your config file and database may need an unpgrade.</p>
...
<p>Lists has been successfully upgraded to version <?php echo $version; ?>.</p>
</div>
